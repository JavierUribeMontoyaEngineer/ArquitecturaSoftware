...
public class ManejadorProgramas extends DefaultHandler {
	private Stack<Programa> pilaProgramasProvisional = new Stack<Programa>();
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		if ("a".equals(qName)) {
			Programa programa = this.pilaProgramasProvisional.pop();
	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		if ("h3".equals(currentElement())) {
			Programa programa = (Programa) this.pilaProgramasProvisional.peek();
